...
# ---------- End functions ----------
# ---------- Variables ----------
# We use capital letters to indicate that these variables are fixed (const) and should not be changed.
GAME_WIDTH = 700
GAME_HEIGHT = 700
SPACE_SIZE = 50
SLOWNESS = 200
...
window.resizable(False, False)  # We use this code to prevent the user from changing the window.
